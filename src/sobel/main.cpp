/*************************************************************************
	> File Name: ../src/sobel/main.cpp
	> Author: Zhu Brocadesoar
	> Mail: brocadesoar@gmail.com
	> Created Time: Sat 02 Sep 2017 04:48:23 AM CST
 ************************************************************************/
...
char tBNameDxCt[] = "Order of Derivation X";
void tBCallDxCt(int, void*);
void tBInitDxCt(void){
    dxCt = 1;
    setTrackbarPos(tBNameDxCt, wdowNameCtrl, dxCt);
    return ;
}

// Order of Derivation Y
// dy = 0,1
// dyCt = 0,1
// dy = dyCt
int dyCt = 1;
...
char tBNameDyCt[] = "Order of Derivation Y";
void tBCallDyCt(int, void*);
void tBInitDyCt(void){
    dyCt = 1;
    setTrackbarPos(tBNameDyCt, wdowNameCtrl, dyCt);
    return ;
}
...
int main(int argc, char** argv){
    ...
    tBInitApeSizeCt();
    createTrackbar(tBNameDxCt, wdowNameCtrl, &dxCt, 1, tBCallDxCt);
    tBInitDxCt();
    createTrackbar(tBNameDyCt, wdowNameCtrl, &dyCt, 1, tBCallDyCt);
    tBInitDyCt();
    while(1){
...
void runCanny(void){
    ...
    Sobel(imageGray, imageEdges, -1, dx(), dy(), apeSize(), thd1(), thd2());
    return ;
}
